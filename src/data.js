...
export const GENES = freeze({
	primary: freeze([
		...
		gene("Arc", UNCOMMON, DUSTHIDE, 306, VEILSPUN, 70),
		gene("Bar", UNCOMMON, MODERN, 6, ABERRATION, 89, AETHER, 150, AURABOA, 238, BANESCALE, 181, DUSTHIDE, 292, GAOLER, 34, UNDERTIDE, 117, VEILSPUN, 145),
		gene("Basic"),
		...
		gene("Checkers", COMMON, DUSTHIDE, 293, UNDERTIDE, 127),
		...
		gene("Fade", COMMON, MODERN, 42, ABERRATION, 90, AETHER, 148, AURABOA, 242, BANESCALE, 85, DUSTHIDE, 296, GAOLER, 86, SANDSURGE, 191, UNDERTIDE, 115, VEILSPUN, 60),
		gene("Falcon", COMMON, MODERN, 16, ABERRATION, 92, AURABOA, 243, BANESCALE, 80, DUSTHIDE, 301, GAOLER, 30, UNDERTIDE, 122, VEILSPUN, 139),
		...
		gene("Giraffe", UNCOMMON, MODERN, 12, ABERRATION, 94, AURABOA, 246, BANESCALE, 81, DUSTHIDE, 297, GAOLER, 27, UNDERTIDE, 123, VEILSPUN, 83),
		gene("Ground", LIMITED, MODERN, 88, ABERRATION, 97, DUSTHIDE, 299, SANDSURGE, 186, UNDERTIDE, 268),
		gene("Harlequin", RARE, MODERN, 170, ABERRATION, 224, AURABOA, 247, DUSTHIDE, 298, SANDSURGE, 192, UNDERTIDE, 280),
		...
		gene("Jupiter", UNCOMMON, MODERN, 14, AETHER, 153, DUSTHIDE, 300, SANDSURGE, 197, UNDERTIDE, 270, VEILSPUN, 64),
		gene("Laced", COMMON, MODERN, 26, AETHER, 156, AURABOA, 249, BANESCALE, 48, DUSTHIDE, 302, GAOLER, 73, VEILSPUN, 61),
		...
		gene("Petals", RARE, MODERN, 13, AETHER, 154, BANESCALE, 51, DUSTHIDE, 304, UNDERTIDE, 281, VEILSPUN, 143),
		gene("Petrified", RARE, DUSTHIDE, 309),
		gene("Phantom", LIMITED, GAOLER, 39),
		gene("Pharaoh", RARE, MODERN, 87, ABERRATION, 101, BANESCALE, 185, UNDERTIDE, 120),
		gene("Piebald", COMMON, MODERN, 9, AETHER, 159, AURABOA, 254, DUSTHIDE, 305, GAOLER, 31, SANDSURGE, 201, UNDERTIDE, 272),
		gene("Pinstripe", LIMITED, MODERN, 22, ABERRATION, 226, BANESCALE, 45, DUSTHIDE, 308, GAOLER, 32, SANDSURGE, 202, UNDERTIDE, 121),
		...
		gene("Ribbon", UNCOMMON, MODERN, 84, ABERRATION, 105, BANESCALE, 183, DUSTHIDE, 311, GAOLER, 175, UNDERTIDE, 124),
		gene("Ripple", UNCOMMON, MODERN, 5, ABERRATION, 228, AURABOA, 257, BANESCALE, 79, DUSTHIDE, 312, GAOLER, 78, UNDERTIDE, 130),
		gene("Sailfish", LIMITED, DUSTHIDE, 313, SANDSURGE, 212),
		gene("Savannah", COMMON, MODERN, 18, ABERRATION, 103, BANESCALE, 50, DUSTHIDE, 314, GAOLER, 176, SANDSURGE, 204, UNDERTIDE, 129),
		gene("Shaggy", COMMON, GAOLER, 29),
		gene("Shell", UNCOMMON, VEILSPUN, 71),
		gene("Skink", LIMITED, MODERN, 15, ABERRATION, 229, AETHER, 161, BANESCALE, 52, DUSTHIDE, 315, GAOLER, 177, VEILSPUN, 67),
		...
		gene("Strike", UNCOMMON, DUSTHIDE, 205),
		...
		gene("Varnish", COMMON, AURABOA, 261, DUSTHIDE, 316, UNDERTIDE, 276),
		gene("Vipera", UNCOMMON, MODERN, 8, ABERRATION, 96, AURABOA, 260, VEILSPUN, 63),
		gene("Wasp", RARE, MODERN, 20, ABERRATION, 108, DUSTHIDE, 310, GAOLER, 28, SANDSURGE, 207, UNDERTIDE, 125, VEILSPUN, 68),
		gene("Wicker", RARE, AURABOA, 262),
		gene("Wolf", UNCOMMON, UNDERTIDE, 116),
		gene("Wrought", COMMON, DUSTHIDE, 307, SANDSURGE, 187, UNDERTIDE, 277)
	]),
	secondary: freeze([
		...
		gene("Basic"),
		gene("Bee", RARE, MODERN, 20, ABERRATION, 108, DUSTHIDE, 310, GAOLER, 28, SANDSURGE, 207, UNDERTIDE, 125, VEILSPUN, 60),
		...
		gene("Blend", COMMON, MODERN, 42, ABERRATION, 91, AETHER, 148, AURABOA, 242, BANESCALE, 85, DUSTHIDE, 296, GAOLER, 86, SANDSURGE, 191, UNDERTIDE, 115, VEILSPUN, 61),
		gene("Breakup", UNCOMMON, MODERN, 58, AETHER, 155, AURABOA, 252, GAOLER, 38, SANDSURGE, 200),
		gene("Butterfly", RARE, MODERN, 13, AETHER, 154, BANESCALE, 51, DUSTHIDE, 304, UNDERTIDE, 281, VEILSPUN, 144),
		gene("Chess", COMMON, DUSTHIDE, 293, UNDERTIDE, 127),
		gene("Clouded", COMMON, MODERN, 40, ABERRATION, 220, BANESCALE, 109, GAOLER, 180, VEILSPUN, 142),
		gene("Coil", UNCOMMON, DUSTHIDE, 205),
		gene("Constellation", RARE, MODERN, 25, ABERRATION, 221, AETHER, 168, AURABOA, 263, UNDERTIDE, 273, VEILSPUN, 66),
		gene("Current", UNCOMMON, MODERN, 6, ABERRATION, 222, AURABOA, 257, BANESCALE, 79, DUSTHIDE, 312, GAOLER, 78, UNDERTIDE, 130),
		gene("Daub", UNCOMMON, MODERN, 7, ABERRATION, 89, AETHER, 150, AURABOA, 238, BANESCALE, 181, DUSTHIDE, 292, GAOLER, 34, UNDERTIDE, 117, VEILSPUN, 145),
		gene("Diamondback", UNCOMMON, AURABOA, 256, SANDSURGE, 206),
		gene("Edged", COMMON, MODERN, 26, AETHER, 156, AURABOA, 249, BANESCALE, 48, DUSTHIDE, 302, GAOLER, 73, VEILSPUN, 62),
		gene("Eel", UNCOMMON, MODERN, 84, ABERRATION, 105, BANESCALE, 183, DUSTHIDE, 311, GAOLER, 174, UNDERTIDE, 124),
		...
		gene("Fissure", LIMITED, MODERN, 88, ABERRATION, 97, DUSTHIDE, 298, SANDSURGE, 186, UNDERTIDE, 268),
		...
		gene("Hex", UNCOMMON, MODERN, 14, ABERRATION, 94, AURABOA, 246, BANESCALE, 81, DUSTHIDE, 297, GAOLER, 27, UNDERTIDE, 123, VEILSPUN, 83),
		gene("Hypnotic", UNCOMMON, MODERN, 9, ABERRATION, 96, AURABOA, 260, VEILSPUN, 64),
		gene("Icing", LIMITED, AETHER, 167),
		gene("Jester", RARE, MODERN, 170, ABERRATION, 225, AURABOA, 247, DUSTHIDE, 299, SANDSURGE, 192, UNDERTIDE, 282),
		gene("Larvae", COMMON, AURABOA, 261, UNDERTIDE, 276),
		gene("Lacquer", COMMON, AURABOA, 241, DUSTHIDE, 316),
		gene("Lode", RARE, DUSTHIDE, 309),
		gene("Loop", UNCOMMON, DUSTHIDE, 306, VEILSPUN, 70),
		...
		gene("Paint", COMMON, MODERN, 10, AETHER, 159, AURABOA, 254, DUSTHIDE, 305, GAOLER, 31, SANDSURGE, 201, UNDERTIDE, 272),
		...
		gene("Peregrine", COMMON, MODERN, 11, ABERRATION, 92, AURABOA, 243, BANESCALE, 80, DUSTHIDE, 301, GAOLER, 30, UNDERTIDE, 122, VEILSPUN, 139),
		...
		gene("Safari", COMMON, MODERN, 18, ABERRATION, 104, BANESCALE, 50, DUSTHIDE, 314, GAOLER, 175, SANDSURGE, 204, UNDERTIDE, 129),
		gene("Sarcophagus", RARE, MODERN, 87, ABERRATION, 101, BANESCALE, 185, UNDERTIDE, 120),
		gene("Saturn", UNCOMMON, MODERN, 15, AETHER, 153, DUSTHIDE, 300, SANDSURGE, 197, UNDERTIDE, 270, VEILSPUN, 65),
		...
		gene("Spinner", LIMITED, MODERN, 16, ABERRATION, 229, AETHER, 161, BANESCALE, 52, DUSTHIDE, 315, GAOLER, 176, VEILSPUN, 68),
		gene("Spire", COMMON, DUSTHIDE, 307, SANDSURGE, 187, UNDERTIDE, 277),
		...
		gene("Trail", LIMITED, MODERN, 22, ABERRATION, 231, BANESCALE, 45, DUSTHIDE, 308, GAOLER, 32, SANDSURGE, 202, UNDERTIDE, 121),
	...
	tertiary: freeze([
		gene("Angler", LIMITED, DUSTHIDE, 286, GAOLER, 156, UNDERTIDE, 246, VEILSPUN, 78),
		gene("Antlers", UNCOMMON, DUSTHIDE, 276),
		gene("Augment", RARE, ABERRATION, 198, DUSTHIDE, 280, SANDSURGE, 173),
		gene("Basic"),
		gene("Batty", LIMITED, AURABOA, 214, DUSTHIDE, 289),
		gene("Beard", UNCOMMON, SANDSURGE, 174),
		gene("Beetle", LIMITED, VEILSPUN, 65),
		gene("Blossom", LIMITED, DUSTHIDE, 281, GAOLER, 36, UNDERTIDE, 267),
		...
		gene("Fishbone", UNCOMMON, AURABOA, 216, DUSTHIDE, 277, SANDSURGE, 185),
		...
		gene("Gembond", UNCOMMON, MODERN, 4, AETHER, 137, DUSTHIDE, 287, SANDSURGE, 176, UNDERTIDE, 123),
		gene("Ghost", UNCOMMON, MODERN, 20, ABERRATION, 88, BANESCALE, 47, DUSTHIDE, 278, GAOLER, 25, UNDERTIDE, 121, VEILSPUN, 131),
		...
		gene("Mandibles", LIMITED, AETHER, 143, DUSTHIDE, 283),
		...
		gene("Polkadot", LIMITED, MODERN, 168, ABERRATION, 79, AURABOA, 238, DUSTHIDE, 293),
		...
		gene("Smoke", UNCOMMON, MODERN, 7, AETHER, 151, AURABOA, 240, DUSTHIDE, 297, GAOLER, 28, UNDERTIDE, 260),
		gene("Soap", RARE, MODERN, 105, BANESCALE, 159, SANDSURGE, 180, UNDERTIDE, 124),
		gene("Space", RARE, AETHER, 149),
		gene("Sparkle", UNCOMMON, MODERN, 97, ABERRATION, 96, AETHER, 152, BANESCALE, 98, DUSTHIDE, 292, GAOLER, 99, SANDSURGE, 193, UNDERTIDE, 122, VEILSPUN, 100),
		gene("Spectre", RARE, SANDSURGE, 188),
		gene("Spines", UNCOMMON, MODERN, 8, ABERRATION, 206, AETHER, 153, AURABOA, 241, BANESCALE, 160, DUSTHIDE, 298, SANDSURGE, 181, UNDERTIDE, 261),
		gene("Spores", RARE, DUSTHIDE, 295),
		gene("Squiggle", LIMITED, BANESCALE, 42),
		gene("Stained", RARE, MODERN, 12, ABERRATION, 207, AETHER, 145, AURABOA, 242, BANESCALE, 69, DUSTHIDE, 274, GAOLER, 71, SANDSURGE, 172, UNDERTIDE, 110, VEILSPUN, 72),
		...
		gene("Underbelly", COMMON, MODERN, 5, ABERRATION, 132, AETHER, 144, AURABOA, 228, BANESCALE, 52, DUSTHIDE, 275, GAOLER, 31, SANDSURGE, 171, UNDERTIDE, 109, VEILSPUN, 70),
		...
		gene("Whiskers", UNCOMMON, AETHER, 154, DUSTHIDE, 291),
