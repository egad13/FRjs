...
export const GENES = freeze({
	primary: freeze([
		...
		gene("Cherub", UNCOMMON, MODERN, 10, ABERRATION, 221, BANESCALE, 43, DUSTHIDE, 340, SANDSURGE, 190, UNDERTIDE, 119, VEILSPUN, 339),
		gene("Chevron", UNCOMMON, BANESCALE, 54),
		gene("Chorus", UNCOMMON, MODERN, 337, VEILSPUN, 338),
		gene("Chrysocolla", LIMITED, AETHER, 320, MODERN, 237, SANDSURGE, 195, UNDERTIDE, 264),
		...
		gene("Crystal", RARE, MODERN, 7, ABERRATION, 91, AETHER, 321, BANESCALE, 182, GAOLER, 37, UNDERTIDE, 118, VEILSPUN, 146),
		...
		gene("Ripple", UNCOMMON, MODERN, 5, ABERRATION, 228, AETHER, 328, AURABOA, 257, BANESCALE, 79, DUSTHIDE, 312, GAOLER, 78, UNDERTIDE, 130),
		...
		gene("Slime", LIMITED, MODERN, 41, ABERRATION, 106, AETHER, 336, GAOLER, 178, SANDSURGE, 208, VEILSPUN, 141),
		...
		gene("Tiger", COMMON, MODERN, 2, AETHER, 331, AURABOA, 259, BANESCALE, 46, GAOLER, 36, SANDSURGE, 211, UNDERTIDE, 275),
		gene("Twinkle", RARE, AETHER, 166),
		gene("Varnish", COMMON, AETHER, 332, AURABOA, 261, DUSTHIDE, 316, UNDERTIDE, 276),
	...
	secondary: freeze([
		...
		gene("Current", UNCOMMON, MODERN, 6, ABERRATION, 222, AETHER, 321, AURABOA, 257, BANESCALE, 79, DUSTHIDE, 312, GAOLER, 78, UNDERTIDE, 130),
		...
		gene("Facet", RARE, MODERN, 8, ABERRATION, 90, AETHER, 323, BANESCALE, 182, GAOLER, 37, UNDERTIDE, 118, VEILSPUN, 146),
		...
		gene("Lacquer", COMMON, AETHER, 328, AURABOA, 241, DUSTHIDE, 316),
		gene("Lode", RARE, MODERN, 318, DUSTHIDE, 309),
		gene("Loop", LIMITED, DUSTHIDE, 306, VEILSPUN, 70),
		gene("Malachite", LIMITED, AETHER, 329, MODERN, 237, SANDSURGE, 195, UNDERTIDE, 264),
		...
		gene("Seraph", UNCOMMON, MODERN, 5, ABERRATION, 228, BANESCALE, 43, DUSTHIDE, 340, SANDSURGE, 190, UNDERTIDE, 119, VEILSPUN, 339),
		gene("Shimmer", RARE, MODERN, 1),
		gene("Sludge", LIMITED, MODERN, 41, ABERRATION, 106, AETHER, 336, GAOLER, 177, SANDSURGE, 208, VEILSPUN, 141),
		...
		gene("Stripes", COMMON, MODERN, 2, AETHER, 334, AURABOA, 259, BANESCALE, 46, GAOLER, 36, SANDSURGE, 211, UNDERTIDE, 275),
	...
	tertiary: freeze([
		...
		gene("Fishbone", UNCOMMON, AETHER, 337, AURABOA, 216, DUSTHIDE, 277, SANDSURGE, 185),
		...
		gene("Nudibranch", LIMITED, AETHER, 327, UNDERTIDE, 126),
		...
		gene("Spores", RARE, AETHER, 332, DUSTHIDE, 295),
		...
		gene("Thorns", UNCOMMON, ABERRATION, 208, AETHER, 333, AURABOA, 226, BANESCALE, 344, DUSTHIDE, 345, GAOLER, 346, SANDSURGE, 347, UNDERTIDE, 263, VEILSPUN, 68),
