...
export const GENES = deepFreeze({
	primary: [
		...
		gene("Boa", UNCOMMON, true, [ABERRATION, AETHER, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
	...
	secondary: [
		...
		gene("Saddle", UNCOMMON, true, [ABERRATION, AETHER, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
