...
export const GENES = deepFreeze({
	primary: [
		...
		gene("Chrysocolla", LIMITED, true, [SANDSURGE, UNDERTIDE]),
		gene("Cinder", UNCOMMON, true, [ABERRATION, AETHER, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		gene("Clown", COMMON, true, [ABERRATION, AETHER, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		...
		gene("Fern", LIMITED, true, [ABERRATION, AURABOA, BANESCALE, UNDERTIDE, VEILSPUN]),
		gene("Flaunt", UNCOMMON, true, [ABERRATION, AETHER, AURABOA, GAOLER, SANDSURGE, UNDERTIDE]),
		gene("Giraffe", UNCOMMON, true, [ABERRATION, AURABOA, BANESCALE, GAOLER, UNDERTIDE, VEILSPUN]),
		gene("Ground", LIMITED, true, [ABERRATION, SANDSURGE, UNDERTIDE]),
		gene("Harlequin", RARE, true, [ABERRATION, AURABOA, SANDSURGE, UNDERTIDE]),
		gene("Iridescent", RARE, true, []),
		gene("Jaguar", UNCOMMON, true, [ABERRATION, AETHER, AURABOA, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE]),
		gene("Jupiter", UNCOMMON, true, [AETHER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		...
		gene("Metallic", RARE, true, [AETHER, AURABOA, BANESCALE, UNDERTIDE]),
		...
		gene("Orb", LIMITED, false, [ABERRATION, AURABOA, UNDERTIDE]),
		gene("Petals", RARE, true, [AETHER, BANESCALE, UNDERTIDE, VEILSPUN]),
		gene("Phantom", LIMITED, false, [GAOLER]),
		gene("Pharaoh", RARE, true, [ABERRATION, BANESCALE, UNDERTIDE]),
		gene("Piebald", COMMON, true, [AETHER, AURABOA, GAOLER, SANDSURGE, UNDERTIDE]),
		...
		gene("Starmap", RARE, true, [ABERRATION, AETHER, AURABOA, UNDERTIDE, VEILSPUN]),
		gene("Stitched", LIMITED, true, [ABERRATION, AETHER, GAOLER, UNDERTIDE, VEILSPUN]),
		gene("Swirl", COMMON, true, [ABERRATION, GAOLER, SANDSURGE, UNDERTIDE]),
		gene("Tapir", COMMON, true, [ABERRATION, AURABOA, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		gene("Tide", LIMITED, true, [ABERRATION, AETHER, BANESCALE, GAOLER, UNDERTIDE]),
		gene("Tiger", COMMON, true, [AURABOA, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE]),
		gene("Twinkle", RARE, false, [AETHER]),
		gene("Varnish", COMMON, false, [AURABOA, UNDERTIDE]),
		...
		gene("Wrought", COMMON, false, [SANDSURGE, UNDERTIDE])
	],
	secondary: [
		gene("Affection", LIMITED, false, [AURABOA]),
		gene("Alloy", RARE, true, [AETHER, AURABOA, BANESCALE, UNDERTIDE]),
		...
		gene("Butterfly", RARE, true, [AETHER, BANESCALE, UNDERTIDE, VEILSPUN]),
		gene("Chess", COMMON, false, [UNDERTIDE]),
		gene("Clouded", COMMON, true, [ABERRATION, BANESCALE, GAOLER, VEILSPUN]),
		gene("Constellation", RARE, true, [ABERRATION, AETHER, AURABOA, UNDERTIDE, VEILSPUN]),
		...
		gene("Eye Spots", COMMON, true, [ABERRATION, AETHER, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		gene("Facet", RARE, true, [ABERRATION, BANESCALE, GAOLER, UNDERTIDE, VEILSPUN]),
		gene("Fissure", LIMITED, true, [ABERRATION, SANDSURGE, UNDERTIDE]),
		gene("Flair", UNCOMMON, true, [ABERRATION, AETHER, AURABOA, GAOLER, SANDSURGE, UNDERTIDE]),
		...
		gene("Jester", RARE, true, [ABERRATION, AURABOA, SANDSURGE, UNDERTIDE]),
		gene("Larvae", COMMON, false, [AURABOA]),
		gene("Lacquer", COMMON, false, [AURABOA, UNDERTIDE]),
		gene("Loop", UNCOMMON, false, [VEILSPUN]),
		gene("Malachite", LIMITED, true, [SANDSURGE, UNDERTIDE]),
		...
		gene("Paint", COMMON, true, [AETHER, AURABOA, GAOLER, SANDSURGE, UNDERTIDE]),
		gene("Paisley", LIMITED, true, [ABERRATION, AURABOA, BANESCALE, UNDERTIDE, VEILSPUN]),
		gene("Patchwork", LIMITED, true, [ABERRATION, AETHER, GAOLER, UNDERTIDE, VEILSPUN]),
		...
		gene("Rosette", UNCOMMON, true, [ABERRATION, AETHER, AURABOA, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE]),
		...
		gene("Saturn", UNCOMMON, true, [AETHER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		...
		gene("Spire", COMMON, false, [SANDSURGE, UNDERTIDE]),
		gene("Spirit", LIMITED, false, [GAOLER]),
		gene("Streak", COMMON, false, [GAOLER]),
		gene("Striation", COMMON, true, [ABERRATION, AURABOA, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE, VEILSPUN]),
		gene("Stripes", COMMON, true, [AURABOA, BANESCALE, GAOLER, SANDSURGE, UNDERTIDE]),
		...
		gene("Weaver", LIMITED, false, [ABERRATION, AURABOA, UNDERTIDE]),
		gene("Web", UNCOMMON, false, [VEILSPUN]),
		gene("Woven", RARE, false, [AURABOA])
	],
	tertiary: [
		gene("Angler", LIMITED, false, [GAOLER, UNDERTIDE, VEILSPUN]),
		...
		gene("Blossom", LIMITED, false, [GAOLER, UNDERTIDE]),
		gene("Braids", UNCOMMON, false, [ABERRATION, GAOLER]),
		gene("Branches", LIMITED, false, [AURABOA, SANDSURGE, UNDERTIDE, VEILSPUN]),
		...
		gene("Contour", COMMON, true, [ABERRATION, AETHER, AURABOA, BANESCALE, GAOLER, UNDERTIDE]),
		gene("Crackle", UNCOMMON, true, [AURABOA, BANESCALE, UNDERTIDE, VEILSPUN]),
		gene("Crest", UNCOMMON, false, [AURABOA, SANDSURGE, UNDERTIDE]),
		gene("Crystalline", LIMITED, false, [AURABOA, GAOLER]),
		gene("Darts", COMMON, false, [SANDSURGE]),
		gene("Diaphanous", RARE, false, [VEILSPUN]),
		gene("Fangs", UNCOMMON, false, [ABERRATION]),
		gene("Fans", RARE, false, [ABERRATION, BANESCALE, GAOLER, UNDERTIDE]),
		gene("Featherbeard", LIMITED, false, [UNDERTIDE]),
		gene("Filigree", RARE, true, [BANESCALE, UNDERTIDE, VEILSPUN]),
		gene("Firebreather", LIMITED, true, [ABERRATION, AURABOA, UNDERTIDE]),
		gene("Firefly", LIMITED, true, [ABERRATION, AURABOA, UNDERTIDE, VEILSPUN]),
		...
		gene("Jellyfish", UNCOMMON, false, [UNDERTIDE]),
		gene("Jewels", RARE, false, [ABERRATION]),
		gene("Keel", LIMITED, true, [AETHER, AURABOA, SANDSURGE, UNDERTIDE]),
		gene("Koi", RARE, true, [ABERRATION, AURABOA, UNDERTIDE, VEILSPUN]),
		...
		gene("Medusa", RARE, false, [AURABOA, UNDERTIDE]),
		...
		gene("Opal", RARE, true, [AURABOA, GAOLER, UNDERTIDE, VEILSPUN]),
		...
		gene("Porcupine", LIMITED, false, [AURABOA, BANESCALE, UNDERTIDE]),
		...
		gene("Scales", LIMITED, true, [ABERRATION, AETHER, AURABOA, UNDERTIDE]),
		gene("Scorpion", LIMITED, false, [GAOLER]),
		gene("Scuttle", LIMITED, false, [AURABOA]),
		gene("Shardflank", COMMON, false, [GAOLER]),
		gene("Shark", LIMITED, false, [SANDSURGE, UNDERTIDE]),
		gene("Skeletal", LIMITED, false, [ABERRATION, BANESCALE]),
		gene("Smirch", LIMITED, true, [ABERRATION, AETHER, SANDSURGE, UNDERTIDE]),
		gene("Smoke", UNCOMMON, true, [AETHER, AURABOA, GAOLER, UNDERTIDE]),
		...
		gene("Spines", UNCOMMON, true, [ABERRATION, AETHER, AURABOA, BANESCALE, SANDSURGE, UNDERTIDE]),
		...
		gene("Stinger", UNCOMMON, false, [AETHER, AURABOA, UNDERTIDE]),
		gene("Tentacles", RARE, false, [UNDERTIDE]),
		gene("Terracotta", COMMON, false, [AURABOA]),
		gene("Thorns", UNCOMMON, false, [ABERRATION, AURABOA, UNDERTIDE, VEILSPUN]),
		gene("Thundercrack", LIMITED, false, [GAOLER, SANDSURGE]),
		gene("Thylacine", COMMON, true, [ABERRATION, GAOLER, SANDSURGE]),
		gene("Topcoat", COMMON, false, [AURABOA, UNDERTIDE]),
		gene("Trickmurk", LIMITED, false, [AETHER, VEILSPUN]),
