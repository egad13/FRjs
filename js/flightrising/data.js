...
export const genes = {
	primary: [
		...
		gene("Fern", "L", true, ["Aberration", "Banescale", "Veilspun"]),
		...
		gene("Harlequin", "R", true, ["Aberration", "Sandsurge"]),
		...
		gene("Leopard", "C", true, ["Aberration", "Banescale", "Gaoler", "Veilspun"]),
		...
		gene("Pinstripe", "L", true, ["Aberration", "Banescale", "Gaoler", "Sandsurge", "Undertide"]),
		gene("Poison", "L", true, ["Aberration", "Banescale", "Gaoler", "Undertide", "Veilspun"]),
		...
		gene("Ripple", "U", true, ["Aberration", "Banescale", "Gaoler", "Undertide"]),
		...
		gene("Skink", "L", true, ["Aberration", "Aether", "Banescale", "Gaoler", "Veilspun"]),
		...
		gene("Starmap", "R", true, ["Aberration", "Aether", "Veilspun"]),
		...
		gene("Tide", "L", true, ["Aberration", "Aether", "Banescale", "Gaoler", "Undertide"]),
	...
	secondary: [
		...
		gene("Clouded", "C", true, ["Aberration", "Banescale", "Gaoler", "Veilspun"]),
		gene("Constellation", "R", true, ["Aberration", "Aether", "Veilspun"]),
		gene("Current", "U", true, ["Aberration", "Banescale", "Gaoler", "Undertide"]),
		...
		gene("Foam", "L", true, ["Aberration", "Aether", "Banescale", "Gaoler", "Undertide"]),
		...
		gene("Jester", "R", true, ["Aberration", "Sandsurge"]),
		...
		gene("Myrid", "L", true, ["Aberration", "Aether", "Sandsurge", "Undertide"]),
		...
		gene("Paisley", "L", true, ["Aberration", "Banescale", "Veilspun"]),
		...
		gene("Seraph", "U", true, ["Aberration", "Banescale", "Sandsurge", "Undertide"]),
		gene("Shimmer", "R", true, []),
		gene("Sludge", "L", true, ["Aberration", "Gaoler", "Sandsurge", "Veilspun"]),
		gene("Spade", "L", false, ["Aberration"]),
		gene("Spinner", "L", true, ["Aberration", "Aether", "Banescale", "Gaoler", "Veilspun"]),
		...
		gene("Toxin", "L", true, ["Aberration", "Banescale", "Gaoler", "Undertide", "Veilspun"]),
		gene("Trail", "L", true, ["Aberration", "Banescale", "Gaoler", "Sandsurge", "Undertide"]),
	...
	tertiary: [
		...
		gene("Contour", "C", true, ["Aberration", "Aether", "Banescale", "Gaoler"]),
		...
		gene("Koi", "R", true, ["Aberration", "Veilspun"]),
		...
		gene("Skeletal", "L", false, ["Aberration", "Banescale"]),
		gene("Smirch", "L", true, ["Aberration", "Aether", "Sandsurge"]),
		...
		gene("Spines", "U", true, ["Aberration", "Aether", "Banescale", "Sandsurge"]),
		gene("Squiggle", "L", false, ["Banescale"]),
		gene("Stained", "R", true, ["Aberration", "Aether", "Banescale", "Gaoler", "Sandsurge", "Undertide", "Veilspun"]),
		gene("Stinger", "U", false, ["Aether"]),
		gene("Tentacles", "R", false, ["Undertide"]),
		gene("Thorns", "U", false, ["Aberration", "Veilspun"]),
